              ...
              [
                ...
                },
                {
                  ...
                  text: [
                    ...
                    "5.时间控制栏: 时间控制栏中的一段时间（例如10秒）代表了现实中的一天时间，随着时间的推移，期货价格发生波动，系统也会定时进行准备金结算。[调节时间速度]键用来调整游戏时间和现实时间的换算比例,[波动浮动调节]键用来调整期货价格的波动幅度。",
              ...
              [
                {
                  ...
                  text:[
                    ...
                    "4.交易: 游戏开始后，您可以在任何时候进行交易（当然，切记真实的期货市场有交易时间的限制），交易分为4种，即买入开仓、卖出开仓、买入平仓、卖出平仓，点击按钮后将跳转页面，您需要输入购买的期货、交易数量和交易价格进行操作。",
